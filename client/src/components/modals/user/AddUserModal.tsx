...
const AddUserModal = ({ showModal, onRefreshUsers, onClose }: AddUserModalProps) => {
                ...
                <div className="modal-dialog modal-lg" role="document">
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            ...
                            <AddUserForm setSubmitForm={submitFormRef} setLoadingStore={setLoadingStore} onUserAdded={(message) => {
                        ...
                        <div className="modal-footer">
                            <button type="button" className="btn btn-secondary" onClick={onClose} disabled={loadingStore}>Close</button>
                            <button type="submit" className="btn btn-primary" disabled={loadingStore} onClick={() => submitFormRef.current?.()}>
                                {loadingStore ? (
                                    <>
                                        <SmolSpinner /> Saving User...
                                    </>
                                ) : (
                                    "Save User"
                                )}
